...
-   Based on *TreeSummarizedExperiment (TreeSE)* class
    ...
    -   Extension of *SingleCellExperiment* class
    -   miaverse is compatible with other *SummarizedExperiment* frameworks
...
Here we analyze if aplha diversities differ between location.
...
from above we can see that group dispersions are not homogenic which is an
...
<img src="figures/mia_logo.png" style="float: right;" width="140"/>
