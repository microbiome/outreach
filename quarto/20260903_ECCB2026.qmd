...
## Orchestrating Hologenome Analysis with Bioconductor {auto-animate="true"}
...
- [https://orchestraplatform.org/](https://orchestraplatform.org/) (by Sean Davis)

![](images/nci.png){fig-alt="NCI logo." fig-align="right" width=20%}
...
::: {.column width="45%"}
![](images/IL.png){style="width:100%; height:585px; object-fit:cover; object-position:top;"}
:::
