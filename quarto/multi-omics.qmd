...
Multiomics provides complementary information. The goal is to combine them effectively.
...
- `r BiocStyle::Biocpkg("MultiAssaySummarizedExperiment")`

::: {.notes}

Using well-defined containers makes multiomics workflows reproducible and interoperable.
...
::: {.notes}
MOFA2 is a popular unsupervised multiomics ordination method. Latent factors can be used for visualization or downstream analyses.
:::
...
::: {.notes}
IntegratedLearner is suitable for multiomics prediction tasks, combining results from each data layer efficiently.
:::
