...
Principal Coordinate Analysis (PCoA) is a method to study **beta diversity**, or
the diversity between microbial communities from different samples.

![](images/tengeler_beta.png){fig-align="center" width="330"}
