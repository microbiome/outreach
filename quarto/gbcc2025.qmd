...
![](https://upload.wikimedia.org/wikipedia/commons/f/fb/Phylogenetic_tree_of_dogs.png){fig-alt="Dog phylogeny" width=20%}

<p style="font-size:xx-small;">Dog phylogeny from Wikipedia</p>
