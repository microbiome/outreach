...
Create a TreeSE directly from its components in the form of raw data (OMA section 3.4). Raw data [here](https://github.com/microbiome/data){target="_blank"}.
...
*Add to exercise 4.3*: Subset to the most prevalent taxa (17.3.3) (tip: subsetByPrevalentFeatures). for count assay; how many features remain? for relative abundance assay; how many features remain?
